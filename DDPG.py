...
class DDPG:
    def __init__(self, alpha, beta, state_dim, action_dim, actor_fc1_dim,
                 actor_fc2_dim, actor_fc3_dim, critic_fc1_dim, critic_fc2_dim, critic_fc3_dim, ckpt_dir,
                 gamma=0.99, tau=0.001, action_noise=0.05, max_size=1000000,
                 batch_size=64):
        self.gamma = gamma
        self.tau = tau
    ...
    def choose_action(self, observation, train=True):
        ...
        if train:
            noise = T.tensor(np.random.normal(loc=0.0, scale=20 * self.action_noise),
